    ...
    <nav className="flex " aria-label="Breadcrumb">
      <ol className="inline-flex items-center space-x-1 md:space-x-3">
        <li className="inline-flex items-center">
          <Link href="/">
            <a className="inline-flex items-center text-sm font-medium hover:text-emerald-400 text-black dark:hover:text-emerald-400">
        ...
        <li aria-current="page">
          <div className="flex items-center">
            ...
            <span className="ml-1 text-sm font-medium text-black md:ml-2 dark:text-black">{slug}</span>
          </div>
        </li>
      </ol>
    </nav>
